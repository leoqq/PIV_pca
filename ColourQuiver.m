function figure_output = ColourQuiver( x, y, u, v, figureprop )
...
if ~exist( 'figureprop','var' ) || isempty( figureprop )
    ...
    temp_figureprop_FieldsDetection = { 'axes_lim', 'xlabel', 'ylabel', 'sparse_vector', 'Clim' };
...
HighSpeedCoordinates_x = ( x_quiver( speedMap_quiver >= 0.75*temp_Clim(2) ) );
HighSpeedCoordinates_y = ( y_quiver( speedMap_quiver >= 0.75*temp_Clim(2) ) );
HighSpeedCoordinates_angle = ( angleMap_quiver( speedMap_quiver >= 0.75*temp_Clim(2) ) );
